#!/bin/bash
#SBATCH --job-name eval-retrieval-map-5percent-RVL_CDIP_50_blurred_A_RvlCdipOriginalVal_emb->RVL_CDIP_50_blurred_A_RvlCdip50BlurredVal_emb
#SBATCH --output eval-retrieval-map-5percent-RVL_CDIP_50_blurred_A_RvlCdipOriginalVal_emb->RVL_CDIP_50_blurred_A_RvlCdip50BlurredVal_emb-%j.out
