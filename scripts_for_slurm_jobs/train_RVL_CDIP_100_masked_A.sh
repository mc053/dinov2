#!/bin/bash
#SBATCH --job-name train-rvl-cdip-100-masked-a
#SBATCH --output train-rvl-cdip-100-masked-a-%j.out
...
echo "$(date)"
echo "Starting RVL_CDIP_100_masked_A training on partition: GPU"
