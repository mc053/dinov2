#!/bin/bash
#SBATCH --job-name eval-retrieval-map-5percent-CelebA_gt_CelebAOriginalVal_emb->CelebA_gt_CelebAOriginalVal_emb
#SBATCH --output eval-retrieval-map-5percent-CelebA_gt_CelebAOriginalVal_emb->CelebA_gt_CelebAOriginalVal_emb-%j.out
...
echo "$(date)"
echo "Starting CelebA retrieval MAP evaluation for scenario "Ground Truth" on partition: GPU"
