...
# Inspired from https://gitlab.com/ziegleto-machine-learning/dino/-/blob/main/visualize_attention.py
...
if __name__ == '__main__':
    ...
    # )
# 
    # model.load_state_dict(torch.load('dinov2_vitl14_pretrain.pth')) # torch.load(f'./{model_name}/eval/training_124999/teacher_checkpoint.pth') (?)
    ...
    img = Image.open('./dinov2/data/datasets/CelebA/CelebA_original/val/162772.jpg')
    img = img.convert('RGB')
